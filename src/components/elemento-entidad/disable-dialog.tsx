    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Esta acción cambiará el estado del elemento a Inactivo (E).
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="rounded-lg bg-muted p-4 space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-sm">{elemento.id}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm font-medium">Nombre:</span>
                <span className="text-sm">{elemento.nombreElemento}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm font-medium">Entidad:</span>
                <span className="text-sm">{elemento.entidad.nombreEntidadSistema}</span>
              </div>
              <div className="flex justify-between">
